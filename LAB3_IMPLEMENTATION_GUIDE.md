TO know what is implemented Search for the tag: (<-HERE)
...
## Task 1: Setup & Run (<-HERE) I want to see how to also make it run. I will check it on 25 Feb 21.00 Swedish Time
